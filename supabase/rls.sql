...
ALTER TABLE IF EXISTS public.vip_emails ENABLE ROW LEVEL SECURITY;
...
REVOKE ALL ON TABLE public.vip_emails FROM anon, authenticated;
...
GRANT ALL ON TABLE public.vip_emails TO service_role;
