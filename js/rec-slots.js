...
(function (global) {
    ...
    function buildExperiencePickHtml(slot) {
        ...
        return `
<section class="hp-card hp-card--stack hp-card--pick" data-rec-slot="${n}" id="rec-slot-${n}">
        ...
        <span class="hp-pick-collapse__peek flex items-center gap-3 min-w-0 flex-1">
            ...
            <span class="min-w-0 flex-1">
                <span class="text-xs font-black flex items-center gap-2">
                    <span class="hp-pick-collapse__num" aria-hidden="true">${n}</span>
                    <i class="fa-solid fa-star text-hp-coral"></i>
                    推薦地點 ${n}
                </span>
